        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <div className="relative md:hidden" ref={userMenuRef}>
            <button
              ...
              className="flex size-8 items-center justify-center rounded-full bg-brand-600 text-xs font-bold text-white shadow-xs focus:ring-2 focus:ring-brand-500 focus:ring-offset-1 cursor-pointer"
            ...
            {mobileUserMenuOpen && (
              <div className="absolute right-0 top-full mt-2 w-52 rounded-2xl bg-white p-2 shadow-2xl border border-slate-200/90 ring-1 ring-slate-900/[0.05] z-50 animate-in fade-in slide-in-from-top-1 duration-150">
                <div className="px-3 py-2 bg-slate-50/80 rounded-xl mb-1.5 border border-slate-100/80">
                  <p className="text-xs font-bold text-slate-900 truncate">{userName}</p>
                  <span className="inline-flex items-center mt-0.5 px-2 py-0.5 rounded-md text-[10px] font-bold bg-blue-50 text-blue-700 border border-blue-100/60">
                    {badge}
                  </span>
                </div>
                ...
                <button
                  ...
                  className="flex w-full items-center gap-2.5 rounded-xl px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50 hover:text-slate-900 transition-colors text-left cursor-pointer"
                >
