      ...
      {result ? (
        ...
        <>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Kullanıcı kodu vergi numaranızdan türetilir. Şifreyi siz belirlersiniz ve personele
            iletirsiniz.
          </p>
          ...
          <form onSubmit={(e) => void handleSubmit(onSubmit)(e)} className="mt-5 space-y-4">
            ...
            <Field label="Rol" error={errors.role?.message}>
              ...
              <p className="mt-1 text-xs text-slate-500">{ROLE_DESCRIPTION[role]}</p>
            </Field>
    ...
    <>
      ...
      {result.role === 'staff' && (
        <p className="mt-3 rounded-lg bg-amber-50 px-3 py-2.5 text-xs leading-relaxed text-amber-900">
          Bu personel henüz hiçbir müşteriye atanmadı ve şu an hiçbirini göremez. Listeden{' '}
          <strong>Müşteri ata</strong> ile kapsamını belirleyin.
        </p>
      )}
