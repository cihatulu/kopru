  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 p-4">
      <div
        role="dialog"
        aria-modal="true"
        aria-label="CSV ile stok yükle"
        className="flex max-h-[90vh] w-full max-w-lg flex-col rounded-xl bg-white p-6 shadow-xl"
      >
        {appliedCount !== null ? (
          <>
          ...
          <>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Şablonu indirin, <strong>stok</strong> sütununu doldurun ve dosyayı geri yükleyin.
              Diğer sütunları değiştirmeyin.
            </p>
