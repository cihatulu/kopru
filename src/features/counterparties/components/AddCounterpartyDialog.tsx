...
import { addCounterpartySchema, isSelfReference, type AddCounterpartyForm } from '../domain/addSchema';
        ...
        {result ? (
          ...
          <>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Vergi numarası yeterli. Firma sistemde kayıtlıysa mevcut kaydına bağlanılır,
              değilse sizin adınıza açılır.
            </p>
