export type CardTone = 'blue' | 'purple' | 'amber' | 'rose' | 'yellow' | 'emerald' | 'pink' | 'teal';

const TONES: Record<CardTone, { card: string; icon: string; dot: string }> = {
  blue: { card: 'from-blue-50 to-blue-100/60 border-blue-100', icon: 'bg-blue-500', dot: 'bg-blue-500' },
  purple: {
  ...
  rose: { card: 'from-rose-50 to-rose-100/60 border-rose-100', icon: 'bg-rose-500', dot: 'bg-rose-500' },
  yellow: {
  ...
  pink: { card: 'from-pink-50 to-pink-100/60 border-pink-100', icon: 'bg-pink-500', dot: 'bg-pink-500' },
  teal: { card: 'from-teal-50 to-teal-100/60 border-teal-100', icon: 'bg-teal-500', dot: 'bg-teal-500' },
};
