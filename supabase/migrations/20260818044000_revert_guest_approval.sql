-- Revert migration: Restore original add_counterparty behavior
--
-- Revert the requirement of approval for existing guest manufacturers when added.
-- Guest manufacturers will be connected (active) immediately when added.
